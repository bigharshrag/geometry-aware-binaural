...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--name', type=str, required=True, help='name of the experiment. It decides where to store models')
		self.parser.add_argument('--checkpoints_dir', type=str, default='checkpoints/', help='models are saved here')
		self.parser.add_argument('--model', type=str, default='audioVisual', help='chooses how datasets are loaded. fairPlay')
		...
		self.parser.add_argument('--split', default='pos', type=str, help='SimBinaural data split')
		self.parser.add_argument('--base_path', type=str, help='base path for FAIR-Play/Youtube-Binaural files')
		self.parser.add_argument('--rir_base_path', type=str, help='base path for RIR files')
		self.parser.add_argument('--ytb_frames_path', type=str, help='path for Youtube-Binaural frames files')
